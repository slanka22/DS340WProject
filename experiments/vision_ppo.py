...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        "-disable_vision_feature", action="store_true", default=False, help="disable vision features"
    )
    argparser.add_argument(
        "-disable_sumo_feature", action="store_true", default=False, help="disable sumo features"
    )
    argparser.add_argument(
    ...
    out_csv = f"outputs/{arg.exp_name}/VisionPPO_{disabled_features}_2way{bev}/csv/{experiment_time}/_"
    if len(arg.test_model) > 0:
        model = PPO.load(arg.test_model)
    else:
        ...
        checkpoint_callback = CheckpointCallback(
            save_freq=arg.seconds/5, save_path=f"outputs/{arg.exp_name}/VisionPPO_{disabled_features}_2way{bev}/logs/{experiment_time}"
        )

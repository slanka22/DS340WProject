...
if __name__ == '__main__':
    ...
    out_csv = f'outputs/DQN_2way/csv/{experiment_time}/_'
    ...
    checkpoint_callback = CheckpointCallback(save_freq=10000, save_path=f"./outputs/DQN_2way/logs/{experiment_time}")

    model_path = f"./outputs/DQN_2way/last_saved_dqn_2way{experiment_time}"

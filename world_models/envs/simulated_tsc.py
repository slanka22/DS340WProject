...
class SimulatedTSC(gym.Env): # pylint: disable=too-many-instance-attributes
    """
    Simulated Traffic Signal Control environment.

    Gym environment using learnt VAE and MDRNN to simulate the
    MetaTraffic-v0 environment.
    ...
    def __init__(self, directory):
        ...
        # spaces WRONG NEED TO UPDATE FOR OUR ENV
...
if __name__ == '__main__':
    ...
    env = SimulatedTSC(args.logdir)

    env.reset()
    action = np.array([0., 0., 0.])

    # TODO CHANGE THIS TO WORK WITH OUR ENV
